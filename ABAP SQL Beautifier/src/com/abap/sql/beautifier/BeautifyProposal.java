...
public class BeautifyProposal implements ICompletionProposal {
	 ...
	 */
	public BeautifyProposal(String replacementString, int replacementOffset, int replacementLength,
			int cursorPosition) {
	 ...
	 *                               proposal
	 */
	public BeautifyProposal(String replacementString, int replacementOffset, int replacementLength, int cursorPosition,
